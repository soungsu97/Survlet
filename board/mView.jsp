...
<div class="container">
	...
	<form action="mupdate.do" method="post">
		...
		<table class="table table-striped table-hover">
			...
			<tr>
				<th>joinDate</th><td colspan="3">${dto.joinDate}</td>
			</tr>
			<tr>
				<td colspan="4">
					<input type="submit" value ="멤버 수정" >
					<input type="button" value ="멤버 삭제" onclick ="location.href='mdelete.do?id=${dto.id}'">
					<input type="button" value ="멤버 목록" onclick ="location.href='mlist.do'">
				</td>
			</tr>
		</table><br><br>
	</form>
